...
const registerSchema = Joi.object({
    username: Joi.string()
        ...
        .error(function(errors){
            errors.forEach(err => {
                if (err.code == 'any.required') err.message = 'Username is required';
                if (err.code == 'string.base') err.message = 'Username is required';
    ...
    password: Joi.string()
        ...
        .error(function(errors){
            errors.forEach(err => {
                if (err.code == 'any.required') err.message = 'Password is required';
                if (err.code == 'string.base') err.message = 'Password is required';
